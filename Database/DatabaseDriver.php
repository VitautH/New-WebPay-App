...
//				self::$connectors[] = $baseName;
	...
	public function getQuery($new = false)
	{
		...
		{
			// Derive the class name from the driver.
			$class =  ucfirst($this->name) . 'Query';
		 Factory::import('Database/'.ucfirst($this->name).'/', $class);
	...
	{
		return version_compare($this->getVersion(), self::$dbMinimum) >= 0;
	}
	/**
